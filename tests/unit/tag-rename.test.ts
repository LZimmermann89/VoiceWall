/**
 * Unit-Tests des Tag-Batch-Renames (M8, ABARBEITUNG 4.8, Entscheidung E29):
 * - Rename ueber 3 Diktate, davon EINES im Papierkorb (Papierkorb ist
 *   bewusst mitbetroffen, E29),
...
beforeEach(async () => {
  ...
  // Das dritte Diktat wandert in den Papierkorb (E29: Rename wirkt auch
...
describe('renameTagEverywhere', () => {
  it('Rename ueber 3 Diktate, eines im Papierkorb: alle Dateien, Manifest und tags.json', async () => {
    ...
    // Auch die Papierkorb-Datei traegt den neuen Tag (E29).
