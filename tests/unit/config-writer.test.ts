 ...
 * das bei setUiSprache real Firmen geloescht haette; vgl. den
 * Lost-Update-Test in companies.test.ts). Der Writer serialisiert
...
describe('GlobalConfigWriter', () => {
  it('Kein Lost-Update: ein langsamer Schreiber verliert die Aenderung eines schnellen nicht', async () => {
