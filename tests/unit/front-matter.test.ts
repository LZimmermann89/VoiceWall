/**
 * Unit-Tests des YAML-Front-Matter-Serializers/-Parsers: Round-trip mit
 * boesartigen Titeln (Quotes, Newlines, YAML-Syntax, Emoji, sehr lang),
 * Injektionsabwehr (kein zweiter Schluessel erzeugbar),
...
describe('front-matter: Parser-Robustheit (Hand-Edits, Angriffe)', () => {
  it('parst ein von Hand geschriebenes Front-Matter (plain Skalare, Kommentare)', () => {
    const content = [
      '---',
