/**
 * Unit-Tests der Firmenordner-Anlage (M5, ABARBEITUNG 4.3/4.4.1):
...
describe('createCompanyFolder', () => {
  ...
  it('uebernimmt auch NFD-/case-Varianten desselben Ordners (Kritik B4)', async () => {
  ...
  it('entschaerft Traversal-Namen und weist Reserviert-/Leernamen ab (M4-Sanitisierung)', async () => {
    // "../../etc" wird zu einem harmlosen Segment INNERHALB der Basis
    // reduziert (ABARBEITUNG 4.3.2, Beispiel); nie ein Pfad ausserhalb.
