...
describe('applyErsetzungen', () => {
  ...
  it('Umlaut-Wortgrenzen: "Müller" wird in "Müllers" NICHT ersetzt (E36)', () => {
    // JavaScript-\b versagt bei Umlauten; die eigene Grenzlogik nutzt
    // Unicode-Property-Klassen. Teilwort-Entscheidung E36: kein Treffer.
...
describe('buildInitialPrompt', () => {
  ...
  it('baut eine kommaseparierte Liste (empirisch verifizierte Form, E37)', () => {
