 ...
 *
 * Alle Läufe laufen vollständig isoliert in Testverzeichnissen
...
test('App startet mit genau einer sichtbaren H1 und sichtbarer Status-UI', async () => {
  ...
  try {
    ...
    // Ueberschrift ist eine H2, die Abschnitts-Ueberschriften sind H3.
...
test('Single-Instance-Lock: zweite Instanz beendet sich sofort', async () => {
  ...
  try {
    ...
    // (zusätzlich existiert das Diktat-Overlay als zweites Fenster).
