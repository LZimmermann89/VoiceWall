/**
 * E2E-Helfer: startet die gebaute App vollstaendig isoliert vom echten
 ...
 * nur in ungepackten Dev-Builds wirksam). Die App entscheidet beim
...
function linkModelsInto(userDataDir: string): void {
  ...
  // Das multilinguale EN-Modell und das fp16-Modell sind
 ...
 * Diktatsprache Deutsch; `sprache: 'en'` legt eine EN-Firma an).
 */
