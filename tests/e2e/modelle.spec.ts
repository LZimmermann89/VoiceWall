/**
 * E2E-Tests des Modelle-Reiters (Verwaltung, Entscheidung E46):
 *
...
/** Zielordner fuer den DoD-Screenshot (Scratchpad via Env, sonst test-results). */
...
test('Modelle-Reiter: Löschen mit Bestätigung, Sperre für das aktive Modell, Wiederherstellen', async () => {
  ...
  try {
    ...
    // DoD-Screenshot: der Reiter mit Status-Uebersicht.
