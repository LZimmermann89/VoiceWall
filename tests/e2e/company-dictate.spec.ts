/**
 * E2E-Test der Firmenverwaltung und des Diktat-Speichers:
 *
...
test('Firma anlegen, Diktat-Flow speichert wohlgeformte .md, Suche findet sie, Firmen sind getrennt', async () => {
  ...
  try {
    ...
    // Die Test-UI zeigt die Firmenliste (minimale Test-UI).
    await window.reload();
