...
test('Wizard startet mit Sprache/Language-Schritt, Wahl English stellt live um', async () => {
...
test('Sprachumschalter in der Verwaltung wechselt live und persistiert', async () => {
...
test('UI auf Englisch zeigt englische Main-Meldungen (Accessibility-Fehlerpfad, zod-Fehler, Footer-Version)', async () => {
