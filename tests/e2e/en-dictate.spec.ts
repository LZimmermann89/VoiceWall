/**
 * E2E-Tests der Diktatsprache Englisch (Paket B1):
 *
...
test('B1: EN-Firma liefert englischen Text ins Clipboard (PCM-Injektion, echtes Modell)', async () => {
...
test('B1: Sprachwechsel der aktiven Firma ueber die UI (Auswahlfeld, Hinweis, Konfig)', async () => {
