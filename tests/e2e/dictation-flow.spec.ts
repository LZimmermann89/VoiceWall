/**
 * E2E-Tests des systemweiten Diktat-Flows (M3).
 *
 ...
 *    vorherige Zwischenablage-Inhalt wiederhergestellt (R7).
...
test('Diktat-Flow: Hotkey registriert, Clipboard-Zustellung, Paste-Mock, Wiederherstellung, Accessibility-Pfad, Overlay-Fokus', async () => {
  ...
  try {
    ...
    // wiederhergestellt: das Transkript verlaesst die Zwischenablage (R7).
