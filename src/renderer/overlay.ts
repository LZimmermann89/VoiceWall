 ...
 *
 * Sprache: jeder Anzeige-Zustand traegt die UI-Sprache aus
 ...
 * String mitliefert (`state.message`, done/error), stammen
...
window.voicewallOverlay.onState((state) => {
  ...
  // A11y: Dokumentsprache folgt der UI-Sprache des Zustands.
