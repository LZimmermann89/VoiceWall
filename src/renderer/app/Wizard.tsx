/**
 * First-Run-Wizard: mehrstufig, jede Stufe validiert
 ...
 * und die Sprachwahl in Schritt 0 (die UI-Sprache wirkt sofort
 ...
 *
 * Barrierefreiheit: komplette Tastatur-Bedienbarkeit, sichtbare
...
export function Wizard(props: WizardProps): ReactElement {
  ...
  // Schritt 4: Diktatsprache (Deutsch empfohlen und Standard).
