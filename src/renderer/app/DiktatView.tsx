/**
 * Ansicht "Diktat": der operative Kopfbereich der Verwaltung. Buendelt
...
/** Deterministischer Vergleichsstand des Wörterbuch-Editors. */
...
export function DiktatView(props: DiktatViewProps): ReactElement {
  ...
  // Sofortmeldungen: Fehler jeder Aktion und der Wörterbuch-Ausgang
  ...
  // "noch nicht gespeichert"-Warnung (Praxistest-Befund: Eintraege
    ...
    async (action: () => Promise<{ ok: boolean; message?: string }>) => {
      ...
      try {
        ...
        if (!result.ok && result.message !== undefined) {
          ...
          // Sofort sichtbar, unabhaengig von der Scroll-Position.
  ...
  // Sichtbare Warnung fuer ungespeicherte Woerterbuch-Aenderungen.
                ...
                onClick={() =>
                  void runAction(async () => {
                    ...
                    if (result.ok) {
                      ...
                      // Erfolg sofort sichtbar bestaetigen.
