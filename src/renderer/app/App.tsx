 ...
 * einrichten") und durchläuft dann nur die Firmen-Schritte.
 *
 * Die App-Shell hält zusätzlich die UI-Sprache: initialisiert
 ...
 * weitere Ansichten lassen sich einhaengen, ohne ein Router-Paket zu brauchen.
 */
...
/**
 * Globale Fehler-Sofortmeldungen: abonniert den zentralen
...
export function App(): ReactElement {
  ...
  // UI-Sprache: Start mit Deutsch, dann einmalig aus der
  ...
  // A11y: die Dokumentsprache folgt der UI-Sprache,
