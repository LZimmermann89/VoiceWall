/**
 * Ansicht "Register": das Aktenverzeichnis der aktiven
 ...
 *
 * Zusaetzlich: Volltextsuche ueber die Bodies (Umschalter, Treffer
...
interface Filter {
  ...
  /** Zusaetzlich in den Volltext-Bodies suchen. */
...
export function RegisterView(props: RegisterViewProps): ReactElement {
  ...
  // Sofortmeldungen: Export-Ausgang zusaetzlich als Toast, die
...
function DetailPanel(props: {
  ...
  // Sofortmeldungen: Export-Ausgang zusaetzlich als Toast.
  const { showError, showSuccess } = useToast();
...
// ---------------------------------------------------------------------------
// Tag-Batch-Rename ("Tags verwalten")
// ---------------------------------------------------------------------------
