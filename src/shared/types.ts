...
export interface VoiceWallBridge {
  ...
  /** Sync-Pruefung des Desktop-Zielordners. */
  ...
  // Verwaltungs-UI: Detail, Bearbeiten, Notiz, Tags, Export, Papierkorb, Beleg.
  ...
  // Stapel-Export, Tag-Batch-Rename, verschluesselter Export.
  ...
  /**
   * Nur Dev/Test (Prompt-Beweis): zuletzt an den Whisper-Worker
...
export interface OverlayStatePayload {
  ...
  /**
   * Sprache der Oberflaeche: der Main-Prozess haengt sie an jeden
