/**
 * Fach-Wörterbuch je Firma (Stufe 1):
 ...
 * Fehltranskriptionen).
 *
 * HARTE GUARDRAIL: Alles hier ist reine, lokale
 ...
 *   nie als Regex (ReDoS-/Injektionsschutz): die Ersetzung laeuft ueber
 ...
 * Test-WAV verifiziert: die Komma-Liste korrigiert die
 ...
 * "Vermeiden", "Müller" nie in "Müllers"). Der eingesetzte
...
/** Eine tatsaechlich angewandte Ersetzungsregel samt Trefferzahl. */
 ...
 * - `von` ist IMMER ein Literal, nie ein Regex (ReDoS-Schutz),
 ...
 * Diktats: '<von> -> <zu> (Nx)'; ein leeres Ziel wird als [entfernt]
