/**
 * Regelbasierte Textaufbereitung des Diktats (Stufe 1).
 *
 * HARTE GUARDRAIL (nicht verhandelbar): Jede Aufbereitung
 ...
 * - Whisper-Interpunktion um Kommandos (Praxistest-Befund):
 ...
 *
 * Sprachabhaengigkeit: Fuellwortliste und
...
/**
 * Die englischen Pendants. "um" ist zugleich ein deutsches Wort;
 ...
 * Praxistest: Nutzer sprechen sie haeufiger als die
...
/**
 * Englische Kommandoliste (gleiche Opt-in-Logik: auch
...
/**
 * Sprachkommandos (Regel 3, Schalter, Default AUS):
 * deutsch "neue Zeile", "Zeilenumbruch", "neuer Absatz", "Absatz", "Punkt",
 * "Komma", "Fragezeichen", "Ausrufezeichen", "Doppelpunkt"; englisch
 * "new line", "new paragraph", "paragraph", "period", "comma" (inklusive
 * gaengiger Aliasse). Bewusst Opt-in: die Kommandowoerter sind auch normale
 ...
 * finalen Text. `sprache` waehlt Fuellwort- und Kommandoliste.
 */
