/**
 * Schleuse fuer native whisper.cpp-/ggml-Logausgaben.
 *
 ...
 * oder Token-TEXT in Logzeilen schreiben. Die Messlatte ist hart: auch
 * debug protokolliert NIEMALS Transkriptinhalte. Ein
