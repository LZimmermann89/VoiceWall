/**
 * Gehaerteter, rein lokaler Logger. Niemals Telemetrie,
 ...
 * - Zwei Log-Streams laut Konzept: 'betrieb' (dieser) und 'setup'
 *   (Installations-/Setup-Log, dockt ueber denselben createLogger an).
 *
 ...
 * Exakttreffer. Deckt die sensiblen Klassen ab:
