 ...
 *
 * Bekannte Grenze (UIPI, Risiko R6): SendKeys aus einem nicht-elevierten
 * Prozess erreicht keine als Administrator laufende Ziel-App. Der
 * Kopieren-Knopf plus Zwischenablage ist dafuer der dokumentierte Ausweg
