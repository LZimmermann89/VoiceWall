 ...
 * die naechste versucht wird. Nur Betriebslog-Zwecke; die fachliche
 ...
 *
 * Quellen-Reihenfolge: erst die Primaerquelle (descriptor.url), dann
...
/**
 * Loescht eine Modelldatei kontrolliert (Modelle-Reiter): Datei
