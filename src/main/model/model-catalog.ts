 ...
 *
 * Die Checksummen wurden selbst mit `shasum -a 256` berechnet und gegen den
 * Hugging-Face-LFS-OID quergecheckt.
 ...
 *
 * Rueckfallquellen: jede Datei ist zusaetzlich als unveraendertes
...
/**
 * Basis-URL des eigenen Modell-Mirrors: unveraenderte Kopien der
...
export interface ModelDescriptor {
  ...
  readonly url: string;
  /**
   * Rueckfallquellen in Versuchsreihenfolge. Jede Quelle wird gegen
   ...
   * resources/model-manifest.json. Die UI zeigt den
   * sprachabhaengigen Anzeigenamen aus dem Katalog (modelLabelFor).
   */
  readonly label: string;
}

/** Sprachabhaengiger Anzeigename eines Modells (UI/Fehlermeldungen). */
...
export const MODEL_CATALOG = {
  ...
  /**
   * Optionales fp16-Modell "Maximale Genauigkeit".
   ...
   * unabhaengige Selbst-Hash-Quercheck (wie beim Q5_0)
   ...
   * Englisch. KEIN Auto-Download: geladen wird
   * erst, wenn eine Firma Englisch waehlt.
   * SHA-256-Herkunft (04.07.2026): Datei von
...
/**
 * Modellwahl-Logik je Diktatsprache: Deutsch nutzt das
 ...
 * benennt Herkunftsmodell und Quantisierung
