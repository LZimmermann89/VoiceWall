 ...
 *
 * Seit M8 nutzen auch der PDF-Export (pdf-export.ts), der Stapel-Export
 ...
 * Dateiname durchlaeuft die Einzelsegment-Containment-Pruefung (M4).
 */
 ...
 * und sicheren relativen Pfad. PDF macht pdf-export.ts (M8).
 */
