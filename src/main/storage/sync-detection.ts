 ...
 *   Registry, siehe paths.ts) enthaelt dann ein `OneDrive`-Segment;
 *   zusaetzlich werden die OneDrive-Umgebungsvariablen als Praefix geprueft.
 * - Dropbox und Google Drive: Pfadmuster.
 *
 * Verhalten: ERKENNEN und WARNEN, plus beide Strategien als
 ...
 *      Symlink; Windows: Directory-Junction, privilegienfrei: kein
 *      PowerShell-.lnk, kein Shell-Aufruf).
 */
 ...
 * (privilegienfrei, kein Developer-Mode noetig).
