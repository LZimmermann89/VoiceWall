/**
 * Containment-Pruefung fuer MEHRSEGMENTIGE relative Pfade.
 *
 * sanitize.ts prueft genau EIN Pfadsegment (Firmenordner-Name). Das
 ...
 * schreiben. Deshalb gilt auch hier: erst
...
export function resolveInsideDir(baseDir: string, relativePath: string): Result<string, string> {
  // NFC-normalisiert vergleichen/aufloesen (macOS liefert teils NFD).
