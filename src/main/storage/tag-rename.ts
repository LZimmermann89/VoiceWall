/**
 * Tag-Batch-Rename (M8, ABARBEITUNG 4.8): ein Tag firmenweit umbenennen.
 *
 * Wirkungsbereich: ALLE Diktate unter `Diktate/` UND der Papierkorb
 * (Entscheidung E29: ein wiederhergestelltes Diktat soll nicht den alten,
 * gerade abgeschafften Tag zurueckbringen). Der Vergleich ist wie ueberall
 * im Tag-System case-insensitiv (de-DE) und NFC-normalisiert.
 *
 * Fehlerstrategie (E29, begruendet): WEITERLAUFEN UND FEHLER SAMMELN statt
 ...
 * ABARBEITUNG 4.4.4) und tags.json wird nachgefuehrt. Gesammelte Fehler
...
export async function renameTagEverywhere(
  ...
  // Papierkorb mit umbenennen (E29): Wiederherstellen bringt sonst den
  // alten Tag zurueck.
