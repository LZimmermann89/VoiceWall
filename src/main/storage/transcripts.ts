/**
 * Transkript-Speicher (M5, ABARBEITUNG 4.4.2/4.4.3): jedes Diktat ist eine
...
export async function createTranscript(
  ...
  for (const fileName of candidates) {
    // Der erzeugte Name durchlaeuft die M4-Einzelsegment-Pruefung: er ist
...
/**
 * Soft-Delete (ABARBEITUNG 4.8): verschiebt die Datei nach `Papierkorb/`.
