/**
 * Aufloesung des Desktop-Basisordners (fuer den Firmenordner, M5/M6).
 *
 ...
 * Interpolation (Command-Injection strukturell ausgeschlossen, ABARBEITUNG
 * 3.4). `%USERPROFILE%\Desktop` dient nur als Fallback, wenn der
 * Registry-Weg scheitert.
 *
