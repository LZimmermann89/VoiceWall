 ...
 * - Pfad-Vergleiche laufen NFC-normalisiert.
 ...
 *   (fuer tausende Eintraege ausreichend; eine Volltextsuche ist erst fuer
 *   v1.1 vorgesehen).
 */
...
/**
 * Selbstheilung: baut das Manifest durch einen
