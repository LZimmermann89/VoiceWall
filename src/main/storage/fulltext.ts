/**
 * Volltextsuche ueber die Markdown-Bodies.
 *
 ...
 *
 * BEWUSST KEIN Volltext-Cache in `.voicewall/`: die Messung mit 1000
 * Fixture-Diktaten (tests/unit/fulltext.test.ts) liegt weit unter der
 * 500-ms-Schwelle; ein Cache waere Komplexitaet ohne Nutzen. Sollte der
 * Bestand jemals deutlich groesser werden, ist der Cache als ableitbares,
 * jederzeit loeschbares Artefakt nachruestbar.
 *
 * Sicherheit (ReDoS-/Injektions-Regel): der Suchbegriff wird IMMER als
