/**
 * Firmenname-Sanitisierung und Pfad-Containment.
 *
 ...
 *      (path.relative-Muster).
 *
 * Zusaetzlich: macOS-Dateisysteme (HFS+/APFS) liefern Namen teils
 ...
 *
 * Dieses Modul ist reine Logik ohne Dateisystemzugriff und wird von der
 * Ordner-Anlage und dem Wizard verwendet.
 */
 ...
 * Noetig, weil macOS-Dateisysteme Namen teils NFD zurueckliefern und
 * macOS/Windows case-insensitiv sind.
 */
