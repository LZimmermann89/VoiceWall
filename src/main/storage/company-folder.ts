/**
 * Anlage des Firmenordners (M5, ABARBEITUNG 4.3/4.4.1).
 *
 * Struktur (exakt nach 4.4.1):
 *   <Basis>/<Firmenname>/
 ...
 *
 * Garantien:
 * - Sanitisierung und Containment kommen ausnahmslos aus sanitize.ts (M4,
 ...
 *   Firmenordner.
 * - Idempotent (4.3.3): existiert bereits eine gueltige VoiceWall-Struktur
...
export async function createCompanyFolder(
  ...
  // Schritt 2: Kollisionspruefung (NFC/NFD- und case-insensitiv, Kritik B4).
  let entries: string[];
  try {
