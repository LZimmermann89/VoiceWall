#!/usr/bin/env node
/**
 * Vendor-Vorbereitung fuer die Offline-Vor-Ort-Installation
 * ("Offline-Vendoring je Plattform als Default").
 *
 * Laeuft auf der Maschine des Betreibers VOR dem Termin (mit Internet), NIE beim Kunden.
